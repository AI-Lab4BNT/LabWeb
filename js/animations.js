    ...
    const themes = {
        ...
        personalized: {
            ...
            paragraphs: [
                ...
                'Our lab collaborates with Dr. Sagarika Bhattacharjee (MBBS, MD, PhD), <a href="https://github.com/CN-PN/LabWeb.git" target="_blank" rel="noopener noreferrer" style="color: #1d4ed8; text-decoration: underline; text-underline-offset: 2px;">Clinical Neurophysiology &amp; Precision Neuromodulation Lab</a> to advance these clinical applications and translate them toward patient care through personalized neuromodulation, clinically informed modeling, and translational research partnerships.'
            ],
